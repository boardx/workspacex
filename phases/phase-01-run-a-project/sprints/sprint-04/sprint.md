# Sprint 01/04 — 个人实时转录与引导式 Deep Research 真栈

- **所属阶段**: Phase 01 (run-a-project)
- **创建于**: 2026-08-12 02:54:39

## 本 sprint 目标
完成个人实时转录服务端链路，并串行交付引导式 Deep Research 真栈闭环。

## 领取的 feature(引用自阶段权威清单,按 id)
- F166 (P1, recording) — 一次性 ASR ticket 与阿里云 Fun-ASR 状态机
- F168 (P1, research) — 研究首页与可恢复会话
