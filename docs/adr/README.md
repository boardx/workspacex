...
| ADR-103 | portable-coord-role-runtime | 稳定角色规格单源生成 Claude Code/Codex 表面；PlatformDirectory 保持运行时角色 SSOT，以 ULID + 0600 本机凭证 + 双租约完成 inbox/ACK/handoff。**Proposed；实现拆为 #441–#446，复用 #396/PR #402。** |
