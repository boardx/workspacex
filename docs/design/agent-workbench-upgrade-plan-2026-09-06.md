...
## 开发进度图（更新于 2026-09-07 04:38 Asia/Shanghai）
...
flowchart TB
  ...
  subgraph FE["前端工作线"]
    ...
    S9["S9 修复中：反馈读取权限\ncommit 59425199f / b0b776692\n录音E2E通过 · 反馈403修复中"]:::active
  ...
  S9 --> S11["S11 CI回归修复中\ncommit d31df2eed / 424943777\n迁移与控制平面CI通过 · 全量待验"]:::active
  S11 --> RM["实模待授权：DashScope外发审批\n测试 commit 8a896dd19\n未运行，不以回环替代"]:::blocked
  S10 --> S11
  S7 --> S11
  R4 -.回归基线.-> S11
  S11 --> S12["S12 待验：新版入口回归\ncommit fa444df27 · PR2890\n核心14通过 · 全栈9通过1失败"]:::active
