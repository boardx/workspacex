...
## 开发进度图（更新于 2026-09-07 08:54 Asia/Shanghai）
...
flowchart TB
  ...
  S1 --> S2["S2 待评审：统一身份与事件契约\ncommit dc1c69c33 / 8186b0ec4"]:::verify
  ...
  S9 --> S11["S11 完整依赖链复验中\ncommit a83730fcb / e86b61e8a\n远端除取消全栈外全绿\n本地78项：61过 / 8败 / 1跳过 / 8未跑"]:::active
  S11 --> RM["实模待授权：DashScope外发审批\n测试 commit 8a896dd19\n未运行，不以回环替代"]:::blocked
  S10 --> S11
  S7 --> S11
  R4 -.回归基线.-> S11
  S11 --> S12["S12 后续导入旅程迁移\ncommit a83730fcb · PR2890\n已提交未推送 · 完整链待复验"]:::active
