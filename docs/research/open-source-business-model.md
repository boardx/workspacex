# WorkspaceX 开源方案（v32.7）—— 完整解决方案、各方体验与可执行门控
...
| 承载 | `knowledge-ontology.md` 的四张 PG 表，每行带 tenant/privacy/permission，RLS 隔离 | **同一套四张 PG 表**——平台大脑就是我们自己那个实例的组织大脑（D14 v32.6）。边缘只有它的投影 |
...
| 层 | 是什么 | 在哪 |
|---|---|---|
| ① 产品本体 | 一个真实 WorkspaceX 实例，跑我们自己的组织；平台大脑用的就是产品的组织大脑能力（同一套本体表），只是装的对象多了所有客户实例 | **可移植层**（PG + pgvector + AGE） |
