...
| **v32.11** | 2026-09-24 | **两项人类决策（出自 `PROP-EXPERT-COMMUNITY-001.md` §9）**：D4 改为分两类——开源导入内容按上游许可免费提供、自研内容闭源售卖（D-EC1）；新增 D18，技能包作者生态**立即开放**，技能包作者从 H2 提前到 H1（D-EC2），4.6 入口改为社区注册表仓库、负责人写成显式缺口 |
