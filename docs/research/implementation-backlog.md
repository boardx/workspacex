...
| D4 | 团队记忆落位（运营平面） | □ | **无依赖**——D14 已定（2026-09-23 人类决策：不 dogfooding），可开工 |
...
| ~~G5~~ | ~~D14 团队记忆是否用自家产品~~ | — | **已定（2026-09-23）**：不 dogfooding，落运营平面。D4 解锁 |
...
## 6. 会推翻计划的事（原三件，D14 已答，剩两件）

| 事 | 若结果不利 | 现在能做什么 |
|---|---|---|
| ~~D14：团队记忆用不用自家产品~~ | ~~用了它就在产品栈，D4 作废~~ | **已答（2026-09-23）：不 dogfooding。D4 按原计划做** |
