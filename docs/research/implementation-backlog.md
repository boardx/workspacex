...
| 等什么 | 挡住什么 | 谁 |
|---|---|---|
| **D16** 联邦运营的是运行事实还是客户内容 | S3 起的整条关键路径 | 决策 |
| **D17** 平台大脑开发过程那一半放哪套图 | D12 → S5 | 决策 |
| **D1** 许可证 | B6 B7 B8、C1（8 个技能包补许可）、C2 | 决策（不可逆） |
| **D13** devportal 公开层去留 | F1 F2 | 决策 |
