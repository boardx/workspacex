...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: /chat-path-(a3-long-session-fact-survival|f2-network-drop-reconnect|f6-concurrent-runs)\.spec\.ts$/,
    },
    {
      /**
