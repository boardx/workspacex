...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      testMatch: /chat-path-(a3-long-session-fact-survival|c4-two-canvases-one-turn|c5-consecutive-artifact-turns|f2-network-drop-reconnect|f6-concurrent-runs)\.spec\.ts$/,
    },
    {
      /**
