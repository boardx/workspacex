...
export function WhiteboardRenderer({ objects, selected, onPointerDown, onKeyboardSelect }: { objects: WhiteboardObject[]; selected: string[]; onPointerDown: (event: PointerEvent, id: string) => void; onKeyboardSelect: (id: string, additive: boolean) => void }) {
