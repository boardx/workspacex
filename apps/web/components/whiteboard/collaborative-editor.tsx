...
export interface CollaborativeEditorProps { doc: Y.Doc; readOnly: boolean; readOnlyReason?: string; title: string; status: string; onTitleChange?: (title: string) => void; onBack?: () => void; onSelectionChange?: (ids: string[]) => void; onAwareness?: (cursor: Point | null, ids: string[]) => void; peers?: WhiteboardConnectionState['peers']; currentUserId?: string }
...
export function CollaborativeEditor({ doc, readOnly, readOnlyReason, title, status, onTitleChange, onBack, onSelectionChange, onAwareness, peers = [], currentUserId }: CollaborativeEditorProps) {
