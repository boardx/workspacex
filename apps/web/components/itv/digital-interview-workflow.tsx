  ...
  return <div className="flex min-h-0 flex-1 flex-col lg:flex-row">
    ...
    <main className="min-w-0 flex-1 overflow-y-auto bg-background p-6 lg:p-10"><div className="mx-auto max-w-5xl">
      ...
      <section className="mt-8 rounded-2xl border border-border bg-card p-6 shadow-sm lg:p-8">
        ...
        {active === "report" && (view.report ? <LiveReportStep report={view.report} evidenceMode={view.studyEvidenceMode} review={view.reportReview} onViewSource={(expertId, questionId) => {
          setActiveStep("runs");
...
function LiveReportStep({ report, evidenceMode, review, onViewSource }: { readonly report: NonNullable<DigitalInterviewWorkflowView["report"]>; readonly evidenceMode: DigitalInterviewWorkflowView["studyEvidenceMode"]; readonly review: DigitalInterviewWorkflowView["reportReview"]; readonly onViewSource: (expertId: string, questionId: string) => void }) {
