...
function LiveQuestionStep({ expertIds, candidates, questions, moderatorPolicy, onPolicyChange, onChange, onConfirm }: { readonly expertIds: readonly string[]; readonly candidates: readonly DigitalExpertCatalogRow[]; readonly questions: readonly DigitalInterviewQuestion[]; readonly moderatorPolicy: DigitalInterviewModeratorPolicy; readonly onPolicyChange: (policy: DigitalInterviewModeratorPolicy) => void; readonly onChange: (questions: readonly DigitalInterviewQuestion[]) => void; readonly onConfirm: () => void }) {
