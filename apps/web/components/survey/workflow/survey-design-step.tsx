  ...
  if (model.questions.length === 0) {
    return <div className="flex min-h-[calc(100vh-5rem)] items-start justify-center p-6" data-testid="survey-design-empty-module">
      <div className="mt-16 w-full max-w-3xl rounded-xl border border-dashed border-border bg-card p-8 text-center shadow-sm">
        ...
        <h2 className="mt-4 text-18 font-semibold">当前模块还没有题目</h2>
        <p className="mt-2 text-12 text-muted-foreground">从空白题目开始，或复制已有问卷模块作为基础后再修改。</p>
        ...
        {!readonly && showModuleChoices && <div className="mt-6 grid gap-3 text-left sm:grid-cols-2" data-testid="survey-design-module-choices">
