...
export function GuidedResearchTrustConsolePreview() {
  ...
  return <main className="mx-auto max-w-7xl space-y-5 p-6">
    ...
    {configured && <>
      <GuidedResearchTrustConsole pending={false} onSteer={(action) => setPaused(action === "pause")} onResolveConflict={() => setReady(true)} runtime={{ planRevision: 1, controlStatus: paused ? "paused" : "running",
