...
export function GuidedResearchReportDocument({ document, provisional = false, historical = false, idPrefix = "", title, actions, onRegenerate, regenerateDisabled = false }: { document: ReportDocument; provisional?: boolean; historical?: boolean; idPrefix?: string; title?: string; limitations?: string; actions?: ReactNode; validationNotice?: ReactNode; onRegenerate?: () => void; regenerateDisabled?: boolean }) {
