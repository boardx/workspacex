...
const initial = SkillSourceBoundDraft.parse({ draft: { skillId: "demo-skill", draftId: "demo-source-draft", revision: 3, snapshotDigest: digest, manifestPath: "SKILL.md", files: [{ path: "SKILL.md", digest, sizeBytes: 42 }, { path: "references/local-notes.md", digest, sizeBytes: 25 }], sourcePin: originalPin, basedOnPublishedVersionId: "demo-published-v1", updatedAt: "2026-09-09T00:00:00Z" }, sourceBinding: { state: "established", baselineId: "demo-original-base" } });
...
export function SourceBindingPreview() {
  ...
  return <main className="min-h-screen bg-background p-6 text-background-foreground"><div className="mx-auto max-w-4xl space-y-5">
    <nav aria-label="来源恢复示例导航" className="flex flex-wrap gap-4 text-13 text-primary"><Link href="/preview/ai-capability-studio/workbench">返回开发工作台</Link><Link href="/preview/ai-capability-studio/import">返回导入向导</Link><Link href="/preview/ai-capability-studio/connections">管理个人来源连接</Link></nav>
