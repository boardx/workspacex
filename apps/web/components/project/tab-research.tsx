...
import {
  INSIGHTS, INSIGHT_SOURCES, UNVERIFIED_HYPOTHESES, ROLE_CAN_WRITE, observerHidden, type ProjectRole,
 ...
 * ⚠ 观察者显著更少：**原始洞察库与未验证假设**是内部研究过程，整块消失；
 *   只保留脱敏的「来源分布」聚合。
 */
export function TabResearch({ view, readOnly = false }: { view: ProjectRole; readOnly?: boolean }) {
