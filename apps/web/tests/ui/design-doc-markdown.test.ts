...
const base: DesignProject = {
  id: "p1", name: "聊天 UI/改版", template: "ui", theme: "dark", accent: "neutral", tokens: { brand: null, font: "sans", radius: "default", density: "default" }, tags: [], refImages: [], share: null, problem: "对话入口太深", criteria: ["首屏可发消息"],
  frames: ["聊天", "设置"],
