...
// issue #4244：展示视图类型搬到非 mock 模块（实时面板要用，产品路由不许够到 mock），这里只转出。
export type { CitationAnchorKind, CitationView } from "../chat-citation-view";
import type { CitationView } from "../chat-citation-view";
