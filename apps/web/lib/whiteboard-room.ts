...
export async function readPairingStatus(boardId:string,pairingId:string){const op=C.operations.pairingStatus;return C.PairingStatus.parse(await apiRequest(path(op.path,{boardId,pairingId}),{method:op.method,body:{}}));}
