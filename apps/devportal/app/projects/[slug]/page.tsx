...
// D13：加入 CTA 指向协作主机 /join/:slug（只读部署配置 DEVPORTAL_COLLAB_HOST，不读任何协作数据）。
import type { Metadata } from "next";
import { ProjectHome } from "@/components/p30/project-home";
import { joinHrefFor } from "@/lib/public-host";
...
export default function ProjectPublicPage({ params }: { params: { slug: string } }) {
  return <ProjectHome slug={params.slug} joinHref={joinHrefFor(params.slug, process.env["DEVPORTAL_COLLAB_HOST"])} />;
}
