...
CREATE TABLE agent_run_interjections (
...
CREATE INDEX agent_run_interjections_pending ON agent_run_interjections(org_id, run_id, sequence)
...
ALTER TABLE agent_runs ADD COLUMN pause_requested_at timestamptz;
