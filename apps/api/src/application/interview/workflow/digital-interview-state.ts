...
export type DigitalInterviewCommand =
  ...
  | { readonly kind: "confirm_topic"; readonly topic: string; readonly researchBrief?: z.infer<typeof interview.DigitalInterviewResearchBrief>; readonly expectedVersion: number; readonly requestId: string }
