...
const TYPES:Record<string,{mime:string;kind:string}>={
 ...
 html:{mime:'text/html',kind:'text'},json:{mime:'application/json',kind:'text'},txt:{mime:'text/plain',kind:'text'},py:{mime:'text/plain',kind:'text'},md:{mime:'text/markdown',kind:'text'},csv:{mime:'text/csv',kind:'text'},
