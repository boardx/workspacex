...
@Module({
  ...
  providers: [
    ...
    { provide: GUIDED_RUNTIME_SERVICE,
      useFactory: (store: GuidedRuntimeStore, model: ModelCallPort, search: GuidedSearchPort, db: DatabasePort) => {
        ...
        return new GuidedRuntimeService(store, model, search, undefined, reportModel, new PgGuidedInternalSourceAccess(db));
      },
      inject: [GUIDED_RUNTIME_STORE, MODEL_CALL_PORT, GUIDED_SEARCH_PORT, DATABASE_PORT] },
    {
