...
export default defineConfig({ test: {
  include: [
    ...
    'tests/whiteboard/mural-api-client.test.ts',
    'tests/whiteboard/mural-direct-import.test.ts',
    'tests/whiteboard/mural-repository-guard.test.ts',
    'tests/whiteboard/mural-controller.test.ts',
  ],
  environment: 'node',
  maxWorkers: 1,
  minWorkers: 1,
