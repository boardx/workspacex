...
describe("verified report evidence coverage", () => {
  ...
  it.each(["unknown source", "unknown question", "fabricated quote", "missing chunk", "duplicate chunk"])("rejects %s extraction instead of trusting model metadata", async (fault) => {
