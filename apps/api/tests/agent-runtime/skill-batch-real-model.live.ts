...
it('real configured model executes the selected synthetic skill scenario',async()=>{
 ...
 if(!['1.0.0','1.1.1','1.1.2'].includes(packVersion)||(packVersion==='1.1.1'&&scenario.packId!=='standard-context')||(packVersion==='1.1.2'&&scenario.packId!=='standard-web'))throw new Error('unsupported case package version');
