...
const input={requestId:'22222222-2222-4222-8222-222222222222',receiptId:'33333333-3333-4333-8333-333333333333',sessionFingerprint:'a'.repeat(64),epoch:1,pendingCount:3,pendingBytes:12,reason:'ACCESS_DENIED' as const};
function controller(requestQuarantineRecovery:WhiteboardRepository['requestQuarantineRecovery']){return new WhiteboardController({requestQuarantineRecovery} as unknown as WhiteboardRepository,{} as never,{} as never,{} as never,{} as never,{} as never);}
