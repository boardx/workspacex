...
describe('whiteboard quarantine recovery contract',()=>{
  const input={requestId:'11111111-1111-4111-8111-111111111111',receiptId:'22222222-2222-4222-8222-222222222222',accessReceiptId:'33333333-3333-4333-8333-333333333333',sessionFingerprint:'a'.repeat(64),epoch:1,pendingCount:100,pendingBytes:4096,reason:'ACCESS_DENIED' as const};
