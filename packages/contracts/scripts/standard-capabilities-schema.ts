...
import { EXECUTION_MODE_CONFIG_KEY, SKILL_PACKAGE_LIMITS, TrustedSkillPackage } from "../src/standard-capabilities";

export function standardCapabilitiesSchema(): string {
  return `${JSON.stringify({
    configurableKeys: { executionMode: EXECUTION_MODE_CONFIG_KEY },
