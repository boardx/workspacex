...
export const ExecutionEvent = z.discriminatedUnion("kind", [
  ...
  z.object({ ...base, kind: z.literal("tool_start"), toolCallId: z.string().min(1), sourceToolCallId: z.string().min(1).optional(), toolName: z.string(), capability: StandardCapabilityDescriptor.optional(), args: z.unknown(), planningNote: z.string().max(4000).optional() }),
