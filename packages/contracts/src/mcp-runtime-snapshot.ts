import {z} from 'zod';
export const MCP_EXECUTION_LIMITS={cancelPollMs:200,cancelAckGraceMs:2000,maxConcurrentExecutions:2,workerHeapMb:128,maxTools:64,maxInvocations:128,maxNameLength:64,maxArgsBytes:262144,maxResultBytes:1048576,deadlineMs:30000} as const;
