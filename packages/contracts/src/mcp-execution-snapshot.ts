...
export const McpFrozenTool=z.object({reviewId:z.string().uuid(),endpoint:z.string(),tool:McpTool,whitelistEntry:ToolWhitelistEntry,runtime:McpRuntimeTool}).strict();
