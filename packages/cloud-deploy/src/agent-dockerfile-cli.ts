...
import { pinAgentDockerfile, lockAgentDockerfile } from "./agent-release.js";
async function main() {
  ...
  const dockerfile = lockAgentDockerfile(pinAgentDockerfile(await readFile(input, "utf8"), baseImage));
