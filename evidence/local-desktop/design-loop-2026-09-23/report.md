...
| S05 | 导出可点击原型：中文项目名转拼音（#3887） | ✅ | hui-yuan-xia-dan-prototype-2026-09-23.html |  |
| S06 | 导出设计文档 / 原型规格：同一套拼音规则 | ✅ | hui-yuan-xia-dan-2026-09-23.md · hui-yuan-xia-dan-2026-09-23.prototype.json |  |
...
| S13 | 手机宽度（375）打开设计详情：画布读得了字，不是一张缩略图 | ✅ | 画布缩放 0.73（读得了字；装不下的部分竖着滚） | [s13-phone-detail.png](./s13-phone-detail.png) |
