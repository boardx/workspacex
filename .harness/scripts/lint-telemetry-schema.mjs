...
const modPath = resolve(arg("--module", join(ROOT, "packages/contracts/src/instance-telemetry.ts")));
const exportName = arg("--export", "InstanceTelemetryReport");
...
console.log("✅ 上报 schema 里没有能装下客户内容的字段");
