...
const unsigned={schemaVersion:1,packId:'standard-document',packVersion:'1.2.0',skills:[{stableName:'document-understanding',name:'文档理解与结构提取',semanticVersion:'1.2.0',manifest:{capabilityId:'WX-S018',runtime:'anydoc-native-locators-ocr'},files}]};
