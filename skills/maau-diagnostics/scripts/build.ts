...
const meta=parseSkillFrontmatter(readFileSync(resolve(root,'SKILL.md'),'utf8'),'maau-venture-valuation');
const unsigned={schemaVersion:1,packId:'maau-diagnostics',packVersion:'2.0.1',skills:[{stableName:meta.stableName,name:'AI 原生递归资产与估值预测',semanticVersion:meta.semanticVersion,manifest:{capabilityId:meta.capabilityId,runtime:'offline-node-pdf-lib'},files}]};
