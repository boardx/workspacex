...
const unsigned={schemaVersion:1,packId:'standard-methods',packVersion:'1.0.1',skills};
const pack={...unsigned,packDigest:sha256(JSON.stringify(unsigned))};
verifySkillStarterPack(pack,{packId:'standard-methods',packVersion:'1.0.1'});
writeFileSync(resolve(root,'../starter-packs/standard-methods/1.0.1.json'),JSON.stringify(pack,null,2)+'\n');
