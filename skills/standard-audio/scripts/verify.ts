...
async function main(){
 ...
 const pack=verifySkillStarterPack(await source.load('standard-audio','1.0.0'),{packId:'standard-audio',packVersion:'1.0.0'});
 ...
 const changed=structuredClone(pack);changed.skills[0]!.files[0]!.contentBase64='dGFtcGVy';assert.throws(()=>verifySkillStarterPack(changed,{packId:'standard-audio',packVersion:'1.0.0'}));
