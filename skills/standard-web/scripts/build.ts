...
const skills=[
 ...
 {stableName:'web-artifact',name:'交互式网页产物',semanticVersion:'1.0.0',manifest:{capabilityId:'WX-S013',upstreamCommit:'41bbe19d1a1a7eaab5e7bb9050a417e5c6cffc8f'},files:collect('web-artifact',['SKILL.md','references/acceptance.md','references/upstream.md','LICENSE'])},
];
const unsigned={schemaVersion:1,packId:'standard-web',packVersion:'1.1.0',skills};
const pack={...unsigned,packDigest:sha256(JSON.stringify(unsigned))};verifySkillStarterPack(pack,{packId:'standard-web',packVersion:'1.1.0'});
writeFileSync(resolve(root,'../starter-packs/standard-web/1.1.0.json'),JSON.stringify(pack,null,2)+'\n');
